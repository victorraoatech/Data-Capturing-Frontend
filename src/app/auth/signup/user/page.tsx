  ...
  const { mutate: submitMutate, isPending } = useMutation({
    ...
    onError: (error: ApiError) => {
      ...
      if (errorMessage.includes('phone') && 
        ...
        setPhoneError('This phone number is already registered. Please use a different phone number or try logging in.');
      } else {
        setPhoneError('');
      }
      ...
      <div className="relative" style={{ width: "1440px", minHeight: "1100px", margin: "0 auto" }}>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <div className={`input-container ${formValues.phone ? 'has-value' : ''} ${errors.phone || phoneError ? 'error' : ''}`}>
                <input
                  type="tel"
                  name="phone"
                  value={formValues.phone}
