...
//   // Direct signup options - no brand/individual, just admin/user
//   const signUpOptions = [
//     { label: "Sign up as Admin", href: "/auth/signup/admin" },
//     { label: "Sign up as User", href: "/auth/signup/user" },
//   ];
...
export default function Navbar() {
  ...
  const isAbout = pathname === "/about"
  const isFeature = pathname === "/feature"
  const isHowItWorks = pathname === "/howIt-works"
  const shouldShowLinks = !pathname?.startsWith("/auth")
  ...
  const getNavLinkClass = (isActive: boolean) => {
    return isActive
      ? "text-[#5D2A8B] underline decoration-[#5D2A8B] decoration-2 text-base font-medium transition"
      : "text-[#1A1A1A] hover:text-[#5D2A8B] hover:underline hover:decoration-[#5D2A8B] hover:decoration-2 text-base font-medium transition"
  }
  ...
  return (
    <header className={`${navbarBackground} transition-all duration-300 z-50 sticky top-0`}>
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Link href="/">
            <Image src="/Group 1.png" alt="Brand Logo" width={40} height={40} className="object-contain" />
          </Link>
        </div>
          ...
          {shouldShowLinks && (
            <div className="flex items-center" style={{ gap: "60px" }}>
              ...
              <nav className="flex items-center" style={{ gap: "40px" }}>
                <Link href="/feature" className={getNavLinkClass(isFeature)}>
                  Features
                </Link>

                <Link href="/howIt-works" className={getNavLinkClass(isHowItWorks)}>
                  How it works
                </Link>

                <Link href="/about" className={getNavLinkClass(isAbout)}>
                  About
                </Link>
              </nav>
              ...
              <div className="flex items-center" style={{ gap: "24px" }}>
                ...
                <div className="relative">
                  <button
                    ...
                    aria-haspopup="true"
                    aria-expanded={isSignUpDropdownOpen}
                    className="focus:outline-none transition-all duration-200 inline-flex items-center font-medium"
                    style={{
                      width: "106px",
                      height: "40px",
                      borderRadius: "20px",
                ...
                <Link
                  href="/auth/login"
                  className="flex items-center justify-center focus:outline-none transition-all duration-200 hover:opacity-90 font-medium"
                  style={{
                    width: "62px",
                    height: "38px",
                    borderRadius: "20px",
      ...
      {isMenuOpen && (
        <div
          className={`md:hidden absolute left-0 right-0 ${isAbout ? "bg-[#d0c1df]" : isScrolledPastHero ? "bg-white" : "bg-[#F4EFFA]"} shadow-md z-40`}
        >
          <nav className="flex flex-col space-y-2 p-4 max-w-7xl mx-auto">
            {shouldShowLinks && (
              <>
                <Link
                  href="/feature"
                  className={getNavLinkClass(isFeature) + " py-2"}
                  onClick={() => setIsMenuOpen(false)}
                >
                  Features
                </Link>
                ...
                <Link
                  href="/howIt-works"
                  className={getNavLinkClass(isHowItWorks) + " py-2"}
                  onClick={() => setIsMenuOpen(false)}
                >
                  How it works
                </Link>

                <Link href="/about" className={getNavLinkClass(isAbout) + " py-2"} onClick={() => setIsMenuOpen(false)}>
                  About
                </Link>
                ...
                <div className="mt-4">
                  <button
                    ...
                    aria-haspopup="true"
                    aria-expanded={isSignUpDropdownOpen}
                    className="flex items-center justify-center focus:outline-none transition-all duration-200 font-medium"
                    style={{
                      width: "106px",
                      height: "40px",
                      borderRadius: "20px",
                ...
                <Link
                  href="/auth/login"
                  className="flex items-center justify-center focus:outline-none transition-all duration-200 font-medium mt-2"
                  style={{
                    width: "62px",
                    height: "38px",
                    borderRadius: "20px",
