...
export default function ClientDetailsMessagePage() {
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            ...
            <p className="text-gray-600">
              View and manage client information, measurements, and order
              history.
            </p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h3 className="font-semibold text-black mb-2">Message Client</h3>
            <p className="text-sm text-gray-600 mb-4">
              Send a message to {client.name}
            </p>
            <button className="w-full bg-[#7c3aed] hover:bg-[#6d28d9] text-white px-6 py-2 rounded-lg font-medium transition-colors">
              Open Chat
            </button>
          </div>
        </div>
